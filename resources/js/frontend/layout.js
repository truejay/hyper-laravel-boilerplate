...
!function ($) {
    ...
    LeftSidebar.prototype._reset = function() {
        ...
        $('#side-main-logo').attr('src', '/img/frontend/logo.png');
        $('#side-sm-main-logo').attr('src', '/img/frontend/logo_sm.png');
    },
    ...
    LeftSidebar.prototype.activateLightTheme = function() {
        this._reset();
        $('#side-main-logo').attr('src', '/img/frontend/logo-dark.png');
        $('#side-sm-main-logo').attr('src', '/img/frontend/logo_sm_dark.png');
