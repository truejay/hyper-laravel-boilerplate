            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 offset-md-2">
                    <div class="text-md-right mt-3 mt-md-0">
                        <img src="/img/frontend/startup.svg" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5 bg-light-lighten border-top border-bottom border-light">
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-lg-4">
                    <div class="demo-box text-center">
                        <img src="/img/frontend/layouts/layout-1.png" alt="demo-img"
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center mt-3 mt-lg-0">
                        <img src="/img/frontend/layouts/layout-2.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center mt-3 mt-lg-0">
                        <img src="/img/frontend/layouts/layout-3.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center">
                        <img src="/img/frontend/layouts/layout-5.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center mt-3 mt-lg-0">
                        <img src="/img/frontend/layouts/layout-6.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center mt-3 mt-lg-0">
                        <img src="/img/frontend/layouts/layout-4.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row mt-2 py-5 align-items-center">
                <div class="col-lg-5">
                    <img src="/img/frontend/features-1.svg" class="img-fluid" alt="">
                </div>
            ...
            <div class="row pb-3 pt-5 align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <img src="/img/frontend/features-2.svg" class="img-fluid" alt="">
                </div>
            </div>
